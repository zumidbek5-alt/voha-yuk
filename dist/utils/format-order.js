...
exports.formatOrderMessage = formatOrderMessage;
...
function formatOrderMessage(order) {
    ...
    const locationText = order.pickup_lat && order.pickup_lng
...
${order.assigned_driver_name
        ? `🚚 Driver: ${order.assigned_driver_name} ${order.assigned_driver_username ? `(@${order.assigned_driver_username})` : ''}\n`
        : ''}
